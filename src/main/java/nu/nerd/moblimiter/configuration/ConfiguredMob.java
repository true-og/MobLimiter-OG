...
public class ConfiguredMob {
    ...
    /**
     * Construct a ConfiguredMob from the YAML configuration. Unspecified values
     * will fall back to the values defined in the default block.
     * 
    ...
    /**
     * Create a dummy ConfiguredMob with default values, for when one isn't actually
     * configured
     * 
    ...
    /**
     * The maximum number of this mob type that should be allowed to exist in a
     * single chunk.
     */
